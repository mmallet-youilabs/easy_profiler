...
set_target_properties(easy_profiler PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libeasy_profiler.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libeasy_profiler.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS easy_profiler )
list(APPEND _IMPORT_CHECK_FILES_FOR_easy_profiler "${_IMPORT_PREFIX}/bin/libeasy_profiler.dylib" )
